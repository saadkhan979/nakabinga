    ...
    <>
      <section>
        <div className="d-flex justify-content-between flex-wrap mb-3">
          <h2 className="screen-title mb-0">Coach Category</h2>
          <CustomButton
            text="Add Category"
        ...
        <Row>
          <Col xs={12}>
            ...
            >
              {(coachCategory?.data?.length || isError) && (
                <tbody>
                  {isError && (
                    <tr>
                  ...
                  {coachCategory?.data?.map((item, index) => (
                    <tr key={item.id}>
                      <td>
                        {serialNum(
...
export default withModal(withFilters(CoachCategory));
