    ...
    <div>
      <div className="d-flex align-items-start mb-4 justify-content-between flex-wrap">
        <div className="d-flex flex-column gap-2">
          <h2 className="screen-title m-0 d-inline"><BackButton /> Video Detail</h2>
        </div>
      </div>
      <div className="d-card py-45 mb-45">
        <div className="d-flex flex-wrap-reverse justify-content-between">
          <div className="mb-3">
            <p className="text-label">Video Title:</p>
        ...
        <div className='row'>
          <div className='col-md-12'>
            <div className='d-inline-block'>
              <Link to={`/admin/content-management/edit-videos/${user?.id}`} className='customButton'>Edit Category</Link>
            </div>
          </div>
      ...
      <CustomModal
        ...
        variant="success"
        title="Success"
        description={`Video has been ${user?.is_active === 0 ? 'Inactivated' : 'Activated'
          } Successfully.`}
      />
...
export default withModal(withFilters(VideoDetail));
