...
import { editEbooksData, getLanguages, viewEbooks } from '../../../Services/Admin/ContentManagement';
...
const EditEbook = ({ showModal, closeModal, setModalLoading }) => {
    usePageTitle('Edit E-Book');
    ...
    const { mutate, isPending } = useMutation({
        mutationFn: editEbooksData,
        onSuccess: () => {
            closeModal();
            showToast('E-Book has been updated successfully!', 'success');
            showModal(
                "",
                "E-Book Has Been Updated Successfully!",
                null,
                "success",
                () => navigate('/admin/content-management', { state: { activeTab: 'ebooks' } })
            );
        },
        onError: (error) => {
            closeModal();
            showToast(error?.message || 'Failed To Update E-Book', 'Error');
        },
    });
        ...
        <div className='d-card py-45 mb-45'>
            <div className="d-flex align-items-start mb-4 justify-content-between flex-wrap">
                <div className="d-flex gap-2">
                    ...
                    <h3 className="screen-title m-0 d-inline">Edit E-Book</h3>
                </div>
            </div>
