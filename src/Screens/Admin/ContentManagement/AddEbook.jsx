...
import { addEbooksData, getLanguages } from '../../../Services/Admin/ContentManagement';
...
const AddEbook = ({ showModal, closeModal, setModalLoading }) => {
    usePageTitle('Add E-Book');
    ...
    const { mutate, isPending } = useMutation({
        mutationFn: addEbooksData,
        onSuccess: () => {
            closeModal(); // Close any open modals
            showToast('E-Book has been added successfully!', 'success'); // ✅ Toast on success
            showModal(
                "",
                "E-Book has been added successfully!",
                null,
                "success",
    ...
    const handleSubmit = (values) => {
        ...
        showModal(
            "",
            "Are You Sure, You Want To Add E-Book?",
            () => {
        ...
        <div className='d-card py-45 mb-45'>
            <div className="d-flex align-items-start mb-4 justify-content-between flex-wrap">
                <div className="d-flex gap-2">
                    ...
                    <h3 className="screen-title m-0 d-inline">Add E-Book</h3>
                </div>
            </div>
