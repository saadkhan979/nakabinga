        ...
        <div>
            <div className="d-flex align-items-start mb-4 justify-content-between flex-wrap">
                <div className="d-flex flex-column gap-2">
                    <h2 className="screen-title m-0 d-inline"><BackButton /> Audio Details</h2>
                </div>
            </div>
                    ...
                    <div className="col-md-10">
                        ...
                        <div className="row">
                            <div className="col-md-4 mb-3">
                                ...
                                <p className="text-data">{user?.category?.name}</p>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-md-4 mb-3">
                                <p className="text-label">Song Player</p>
                                {user?.file ? (
                                    <audio
                                        controls
                                        src={user.file}
                ...
                <div className='row'>
                    <div className='col-md-12'>
                        <div className='d-inline-block'>
                            <Link to={`/admin/audio-management/edit-audio/${user?.id}`} className='customButton'>Edit</Link>
                        </div>
                    </div>
            ...
            <CustomModal
                ...
                variant="success"
                title="Success"
                description={`Audio has been ${user?.is_active === 0 ? 'Inactivated' : 'Activated'
                    } Successfully.`}
            />
...
export default withModal(withFilters(AudioDetails));
